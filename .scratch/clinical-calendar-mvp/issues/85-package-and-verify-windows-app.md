...
- 2026-08-04: Rebuilt the Windows release bundle after production backup/restore and export navigation were connected, then revalidated MakeAppx structure at version 0.1.0.4. The unsigned structure artifact SHA-256 is `ca87d7b5...6e9872a`; it remains explicitly non-distributable. Durable certificate signing and clean-machine install/upgrade/offline/file-picker/recovery evidence are still required.
